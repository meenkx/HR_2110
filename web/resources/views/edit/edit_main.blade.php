    ...
    <div class="container-fluid">
        <div class="row justify-content-center" style="border-bottom: 1px solid black;padding: 10px 50px">
            <div class="col-md-11" style="display: inline-flex;">
                ...
                <table style="font-size: 25px;background-color: #ffc439;height: 85%;border-radius: 15px 15px 0px 0px;text-align: center;width: 750px;position: relative;bottom: -24px;">
                    <tbody>
                        <tr>
